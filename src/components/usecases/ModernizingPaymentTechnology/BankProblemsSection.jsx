// components/usecases/ModernizingPaymentTechnology/BankProblemsSection.jsx
  ...
  const problems = [
    {
      ...
      solution: "Partner with us to easily implement cutting-edge technologies like pay-by-link, advanced tokenization and many more than enhancing your merchant offering.",
      icon: "💡",
    },
    {
      ...
      solution: "Integrating with us grants access to over 650+ payment methods, simplifying expansion and enabling banks to effectively serve local merchants or capture new markets.",
      icon: "🌍",
    },
    {
    ...
    },
    {
      ...
      challenge: "Legacy systems often hold banks back, complicating the transition to more sophisticated infrastructures without impacting merchant experience.",
